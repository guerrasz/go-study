...
func (x *SayHelloResponse) GetConfMessage() string {
	if x != nil {
...
const file_proto_main_proto_rawDesc = "" +
	"\n" +
	"\x10proto/main.proto\x12\x04main\x1a\x15proto/user/user.proto\"7\n" +
	...
	"\bSayHello\x12\x15.main.SayHelloRequest\x1a\x16.main.SayHelloResponse\x12/\n" +
	"\x0eGetUserProfile\x12\n" +
	".user.User\x1a\x11.main.UserProfileB\x13Z\x11/proto/gen;mainpbb\x06proto3"
...
var file_proto_main_proto_goTypes = []any{
	(*SayHelloRequest)(nil),  // 0: main.SayHelloRequest
	(*SayHelloResponse)(nil), // 1: main.SayHelloResponse
	(*UserProfile)(nil),      // 2: main.UserProfile
	(*user.User)(nil),        // 3: user.User
}
var file_proto_main_proto_depIdxs = []int32{
	0, // 0: main.GreeterService.SayHello:input_type -> main.SayHelloRequest
	3, // 1: main.GreeterService.GetUserProfile:input_type -> user.User
	1, // 2: main.GreeterService.SayHello:output_type -> main.SayHelloResponse
	2, // 3: main.GreeterService.GetUserProfile:output_type -> main.UserProfile
